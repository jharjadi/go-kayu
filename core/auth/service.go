...
type Interface interface {
	...
	CreateAdminUser(ctx context.Context, email, password, firstName, lastName string, organisationID string) (*model.Account, error)

	CreateAdminUserWithNewOrganisation(ctx context.Context, email, password, firstName, lastName, orgName string) (*model.Account, *model.Organisation, error)
