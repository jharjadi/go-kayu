...
func (a *App) bootstrap(ctx context.Context) error {
	...
	// Run admin bootstrapping after auth service is initialized and database is ready

	if err := a.auth.BootstrapAdmin(ctx); err != nil {

		// Log the error but continue with bootstrap - admin creation failure shouldn't prevent app from starting
